...
class CartPage extends React.Component {
    ...
    onOKPass = () => {
        ...
        //siapkan data yang mau dipush ke history
        let data = {
    ...
    render() {
        const {error, visibility, askPass, toHistory} = this.state
        ...
        return (
            <div style={{ backgroundColor: '#FFCDDD', padding: '1%', minHeight: '100vh'}}>
                <NavigationBar />
                <div fixed="top" style={{display: 'flex', justifyContent: "space-between", alignItems: 'center', marginTop: '10vh'}}>
